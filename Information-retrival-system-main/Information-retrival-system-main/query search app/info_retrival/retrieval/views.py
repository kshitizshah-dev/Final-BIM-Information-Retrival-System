...
def retrieve_documents(request):
    if request.method == "POST":
        ...
        folder_path = r'C:\Users\kshitz shah\Downloads\Information-retrival-system-main\Information-retrival-system-main\query search app\books'  # Set the path to your documents folder
